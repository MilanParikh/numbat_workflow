...
RUN R -e "devtools::install_github('https://github.com/kharchenkolab/scistreer')"
RUN R -e "devtools::install_github('https://github.com/kharchenkolab/numbat/tree/devel')"

COPY create_allele_file.R /numbat/inst/bin/
